...
class _EditarWidgetState extends State<EditarWidget> {
  ...
  void initState() {
    ...
    _model.fieldNombreController ??=
        TextEditingController(text: widget.mueble?.name);
    _model.fieldNombreFocusNode ??= FocusNode();

    _model.fieldPrecioController ??=
        TextEditingController(text: widget.mueble?.price.toString());
    _model.fieldPrecioFocusNode ??= FocusNode();

    _model.fieldAltoController ??=
        TextEditingController(text: widget.mueble?.alto.toString());
    _model.fieldAltoFocusNode ??= FocusNode();

    _model.fieldLargoController ??=
        TextEditingController(text: widget.mueble?.largo.toString());
    _model.fieldLargoFocusNode ??= FocusNode();

    _model.fieldAnchoController ??=
        TextEditingController(text: widget.mueble?.ancho.toString());
    _model.fieldAnchoFocusNode ??= FocusNode();

    _model.fieldDescripcionController ??=
        TextEditingController(text: widget.mueble?.description);
    _model.fieldDescripcionFocusNode ??= FocusNode();
          ...
          child: Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Text(
                    'Puede modificar cada aspecto del mueble',
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          builder: (context, snapshot) {
                            ...
                            return FlutterFlowDropDown<String>(
                              controller:
                                ...
                                _model.dropMaterialesValue ??=
                                    widget.mueble?.material,
                              ),
                        ...
                        TextFormField(
                          controller: _model.fieldDescripcionController,
                          focusNode: _model.fieldDescripcionFocusNode,
                          autofocus: true,
                          obscureText: false,
                          decoration: InputDecoration(
                            labelStyle:
                          ...
                          minLines: 6,
                          cursorColor: FlutterFlowTheme.of(context).primary,
                          validator: _model.fieldDescripcionControllerValidator
                              .asValidator(context),
                        ),
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await widget.mueble!.reference.update({
                          ...createProductosRecordData(
                            ...
                            description: _model.fieldDescripcionController.text,
