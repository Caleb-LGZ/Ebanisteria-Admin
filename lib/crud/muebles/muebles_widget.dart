...
import 'muebles_model.dart';
export 'muebles_model.dart';

class MueblesWidget extends StatefulWidget {
  const MueblesWidget({super.key});
...
class _MueblesWidgetState extends State<MueblesWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MueblesModel());
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed(
                                'Editar',
                                queryParameters: {
                                  'mueble': serializeParam(
                                    listViewProductosRecord,
                                    ParamType.Document,
                                  ),
                                }.withoutNulls,
                                extra: <String, dynamic>{
                                  'mueble': listViewProductosRecord,
                                },
                              );
                            },
                            child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: AutoSizeText(
                                                listViewProductosRecord.material
                                                    .maybeHandleOverflow(
                                                  maxChars: 70,
                                                  replacement: '…',
                                                ),
